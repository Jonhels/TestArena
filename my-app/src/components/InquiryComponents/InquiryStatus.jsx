...
import "./InquiryStatus.css";
import arrowleft from "../../assets/images/arrow-left.svg";


const InquiryStatus = ({ inquiryId, inquiryData, onUpdate }) => {
    const [admins, setAdmins] = useState([]);
    const [selectedAdmin, setSelectedAdmin] = useState(inquiryData?.assignedTo?._id || "");
    ...
    const handleAssignChange = async (e) => {
        ...
        try {
            ...
            onUpdate?.({ assignedTo: newAdminId }); // <-- pass updated field
        } catch (err) {
    ...
    const handleStatusChange = async (e) => {
        ...
        try {
            ...
            } else if (["ulest", "i arbeid"].includes(newStatus) && inquiryData.archived) {
