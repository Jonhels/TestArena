...
const AiRecommendation = ({ data }) => {
  ...
  return (
    <div className="top-info-panel">
      <div className="recommendation-toggle-header" onClick={() => setIsOpen(!isOpen)}>
        <h2 className="section-title">AI: Forslag til passende kontakter og ressurser</h2>
        <img
              ...
              <div key={idx} className="recommendation-card">
                <div className="recommendation-header">
                  ...
                  <div className="recommendation-details">
                    ...
                    <p>{rec.responsibility} &nbsp; <span className="dot">•</span> &nbsp; Lokasjon: {rec.officeLocation}</p>
                    <p>Email: {rec.email}</p>
