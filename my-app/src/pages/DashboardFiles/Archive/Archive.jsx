...
import ArchiveList from "../../../components/ArchiveComponents/ArchiveList";
import ArchiveHeader from "../../../components/ArchiveComponents/ArchiveHeader";
 ...
 useEffect(() => {
  const fetchArchived = async () => {
    try {
      ...
      const archivedOnly = res.data.inquiries?.filter((inq) => inq.archived === true);
